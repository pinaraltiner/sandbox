...
source("D:/dev/Desktop_copy/PHD/data_analysis/scripts/getModificationPositionMQ_func_edit.R")
...
file_path <- "D:/dev/Desktop_copy/PHD/wet_lab_experiments/DDA_data_analysis/experiment_2/MQ_214_optimize_param_noFAIMS/"
...
for (k in 1:sample_size){
  ...
  assign(paste0("row_means_abundances_A",k),as.data.frame(rowMeans(df_merge %>% select(contains(paste0("E2-A",k))))))
  
  
  assign(paste0("log10_abundances_A",k),as.data.frame(log10(df_merge  %>% select(contains(paste0("E2-A",k)))))) 
