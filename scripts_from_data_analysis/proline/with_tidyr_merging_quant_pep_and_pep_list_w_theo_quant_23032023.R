...
library(tidyr)
###############################################
source("D:/dev/Desktop_copy/PHD/data_analysis/scriptsg/gplot_functions.R")
...
gg_density_exp_ratio(data_set = df_for_figure, 
...
gg_density_exp_ratio(data_set = figure_with_mean_abundance, 
...
gg_boxplt_exp_ratio(data_set = df_for_figure, 
...
gg_half_boxplt_exp_ratio(data_set = df_for_figure, 
                    x_df = df_for_figure$Theo_Exp,
                    y_df = df_for_figure$Ratios,
                    fill_df = df_for_figure$Pool,
                    header="Experimental Quantity Ratio of Synthetic Peptides",
...
gg_violin_exp_ratio(data_set = df_for_figure, 
                         x_df = df_for_figure$Theo_Exp,
                         y_df = df_for_figure$Ratios,
                         fill_df = df_for_figure$Pool,
                         header="Experimental Quantity Ratio of Synthetic Peptides",
