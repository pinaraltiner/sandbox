...
final_proline_pep_quant_analysis <- function(file_path,
 ...
 ### TODO: Extract where the first FALSE was generated to use for threshold of each comparison.
  ...
  write.table(roc_final,file = "D:/dev/Desktop_copy/PHD/wet_lab_experiments/DDA_data_analysis/experiment_2/Proline_data_analysis/exp2_re_injection/exp2_no_FAIMS_proline_roc_curve_data.tsv",sep = "\t",row.names = F)
  ...
  ggplot(roc_curve_combine_proline_mq_score_0_40,aes(x=fdp,y=tpr)) + 
