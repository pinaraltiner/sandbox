...
final_proline_pep_quant_analysis <- function(file_path,
  ...
  df_modified <- sort_syn_phospho_pep_proline_new %>%
    select(starts_with("abundance")) %>%
    setNames(experiment_name) 
  mutate(across(starts_with("E2_A1"), get_na_count_value),
         across(starts_with("E2_A2"), get_na_count_value),
         across(starts_with("E2_A3"), get_na_count_value),
         across(starts_with("E2_A4"), get_na_count_value),
         across(starts_with("E2_A5"), get_na_count_value))
