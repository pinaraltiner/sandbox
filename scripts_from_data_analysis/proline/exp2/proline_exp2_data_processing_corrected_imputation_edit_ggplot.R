...
final_proline_pep_quant_analysis <- function(file_path,
  ...
  df_merge <- df_result %>% left_join(pep_list_w_theo_quant_new,by="common_col_for_merging")
 ...
 ### TODO: Extract where the first FALSE was generated to use for threshold of each comparison.
  ...
  p_thresholds<- c(2.485779e-02,1.945531e-02,3.219350e-02,2.703404e-02)
  ...
  ggplot(roc_proline_mq,aes(x=fdp,y=tpr,color=Comparison,linetype=Software)) + geom_line(size=1) +
    theme_bw() +
