...
exp1_wo_faims_wo_Ecoli <- read.xlsx("PAL _Phosphopeptides exp1_wo_Ecoli_noFAIMS_DDA_230208_2023-05-23_1650.xlsx",sheet = "All PSMs from protein sets")
...
phospho_ptm_pos <- lapply(id_syn_phospho_pep$ptm_protein_positions, function(each_ptm_protein_positions) {
