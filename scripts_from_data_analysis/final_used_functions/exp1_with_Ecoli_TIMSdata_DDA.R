...
a <- setwd("D:/dev/Desktop_copy/PHD/wet_lab_experiments/DDA_data_analysis/experiment_1/Proline_timstof_with_Ecoli/Proline_identification_results_new/")
list_files <- list.files(a)[-c(1,2,3,12,13)]
...
# write.table(df_merge_localization,file=paste0(a,"/","PAL_Exp1_with_coli_DDA_TIMSdata_localization_merge.tsv"),sep = "\t",row.names = F,col.names = T)
# 
# write.table(df_merge_sequence,file=paste0(a,"/","PAL_Exp1_with_coli_DDA_TIMSdata_sequence_merge.tsv"),sep = "\t",row.names = F,col.names = T)
